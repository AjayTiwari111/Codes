...
# Example usage:
n_start = 150  # Starting value of n
n_end = 250   # Ending value of n

valid_values = find_valid_parameters(n_start, n_end)
print("Valid (n, k, s) values where Wiener index is unchanged and diam(H)=1, diam(Hwithout0)=2:", valid_values)
